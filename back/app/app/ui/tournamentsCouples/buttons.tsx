  ...
  return (
    ...
    >
      {isLoading ?
        <>
          Cargando
          <svg aria-hidden="true" role="status" className="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 h-5 md:ml-4" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function AddGroupResult({ tournamentID }: { tournamentID: string }) {
  ...
  return (
    <Link
      href={`/dashboard/tournaments/${tournamentID}/group-results/create`}
      className="flex p-4 items-center rounded-lg bg-blue-600 px-4 text-sm font-medium text-white transition-colors hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
      onClick={() => {
        setIsLoading(true)
      }}
